...
public class PhoneBook {
    ...
    public void add(String surname, String number){
        if(book.containsKey(surname)){
            ...
            if(!numbers.contains(number)){
                ...
                System.out.println(String.format("Номер %s уже записан для фамилии %s", number, surname));
            }
        } else {
    ...
    public List<String> get(String surname){
        if(book.containsKey(surname)){
            ...
            System.out.println(String.format("В справочнике нет записи с фамилией %s", surname));
